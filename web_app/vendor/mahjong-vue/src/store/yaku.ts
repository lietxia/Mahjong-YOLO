...
import { HandSet, MENZEN, TSUMO, FIELD_EAST, FIELD_SOUTH, FIELD_WEST, FIELD_NORTH, SEAT_EAST, SEAT_SOUTH, SEAT_WEST, SEAT_NORTH, CHANKAN, RINNSHANN_KAIHOU, HAITEI_RAOYUE, HOUTEI_RAOYUI, RIICHI, BlockType, MachiType, IPPATSU, Pai, DOUBLE_RIICHI, TENHOU, CHIIHOU } from "./types";
